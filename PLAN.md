...
- [ ] 4P.3 Retrofit: audit every FK + hot filter column across migrations 0002–0015 against PERFORMANCE §1; one migration adding all missing indexes (tenant_id leads composites); issue-first per finding
