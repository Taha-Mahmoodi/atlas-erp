/**
 * AP aging report (STRUCTURE §4): open-bill buckets per vendor as of a date, plus the
...
import { useApAging } from "@/modules/finance/hooks";
...
export function ApAgingPage() {
  ...
  const aging = useApAging(asOf, partnerId || undefined);
