    ...
    <div className="mx-auto max-w-3xl">
      <header className="mb-6">
        <p className="text-[12px] text-ink-muted">
          <Link to="/finance/vendor-bills">Vendor Bills</Link> / <span className="text-ink">New vendor bill</span>
        </p>
        <h1 className="mt-1.5 text-[22px] font-[650] tracking-[-0.01em] text-ink">New vendor bill</h1>
      </header>
      {error && (
