/**
 * The sales module's own landing page (STRUCTURE §4: modules/sales/pages/). Slice 1/4 of PLAN
 * 15.7 — customers and pricing; quotes/orders/deliveries/billing/returns land in later slices.
 */
