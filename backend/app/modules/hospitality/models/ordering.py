"""Hospitality ordering models (PLAN 19): the stored menu-availability row and the order-ticket
document with its lines.
...
__all__ = ["MenuAvailability", "OrderTicket", "OrderTicketLine"]
