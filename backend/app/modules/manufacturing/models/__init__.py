...
(the production-order header + exploded components + routing-snapshot operations). Re-exported here
so call sites use one import (``from app.modules.manufacturing.models import Bom``) and the alembic
env.py / tenancy mapper-enumeration suite see every model through this package.
"""
